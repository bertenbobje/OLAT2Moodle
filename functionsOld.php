...
// function moodleGetSubjects(&$moodleActivity, $olatSubject, $olatChapter, &$indent) {
	// if($olatChapter->getSubject() != null) {
		// foreach ($olatChapter->getSubject() as $olatSubject) {
			// $indent++;
			// $type = $olatSubject->getSubjectType();
			// $ok = 0;
			...
			// if ($ok == 1) {
				...
				// $moodleActivity->setIndent($indent);
			// }
			// moodleGetSubjects($moodleActivity, $olatSubject->getSubject(), $olatChapter, $indent);
			// $
		// }
	// }
// }
